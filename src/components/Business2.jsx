...
const Business2 = () => {
  ...
  const data = [
    {
      number: "1",
      title: "Giải pháp các hệ thống quản lý an ninh tích hợp (iss)",
    },
    {
      number: "2",
    ...
    {
      number: "4",
      title: "Hệ thống giám sát lịch trình bảo vệ điện tử (guard tour)",
    },
    {
      number: "5",
    ...
    {
      number: "7",
      title: "Hệ thống kiểm soát phân tầng thang máy",
    },
    {
      number: "8",
      title: "Hệ thống quản lý bãi giữ xe thông minh",
    },
          ...
          <CustomAppBar component="nav" position="sticky" elevation={0}>
            ...
            >
              ...
              >
                <ProjectBox
                  icon={<SecurityIcon />}
                  title="HỆ THỐNG AN NINH TÍCH HỢP (ISS)"
                />
                <ProjectBox
