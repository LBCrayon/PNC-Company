  ...
  return (
    <>
      <Stack
        container
        sx={{
          backgroundImage: `url("https://anbao.com.vn/upload/assets/2021/1223/ba/pull1-1.jpg")`,
        ...
        <CustomBox component="header">
          <CustomAppBar component="nav" position="sticky" elevation={0}>
            ...
            <Stack mx={30} justifyContent={"start"} spacing={2} mt={4}>
              ...
              >
                TRUNG TÂM HỘI NGHỊ TRIỂN LÃM QUỐC TẾ (PULLMAN)
              </Typography>
              <Typography
                variant="h5"
                component="h5"
...
export default Projects8Details;
