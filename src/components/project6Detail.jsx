import {
    ...
    return (
      <>
        <Stack
          container
          sx={{
            backgroundImage: `url("https://resviet.vn/wp-content/uploads/2021/01/phoi-canh-tttm-Gigamall-pham-van-dong-thu-duc-scaled.jpg")`,
  ...
  export default Projects6Details;
