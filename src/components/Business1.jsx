...
const Business1 = () => {
  ...
  const data = [
    { number: "1", title: "Hệ thống Phủ sóng di động" },
    {
      number: "2",
      title: "Hệ thống cáp quang cung cấp dịch vụ Internet và Truyền hình cáp",
    },
  ...
  return (
    <>
        ...
        <CustomBox component="header">
          <CustomAppBar component="nav" position="sticky" elevation={0}>
            ...
            >
              ...
              >
                HỢP TÁC ĐẦU TƯ HẠ TẦNG VIỄN THỐNG
              </Typography>
            </Stack>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
      ...
      >
        {data.map((item, index) => (
          <Grid key={index} xs={8}>
            <Grid container columns={16} sx={{ flexGrow: 1 }}>
              <Grid xs={4}>
                <Box
                  display="flex"
                  justifyContent="center"
