  ...
  return (
    <>
      <Stack
        container
        sx={{
          backgroundImage: `url("https://www.rmit.edu.vn/content/dam/rmit/vn/en/assets-for-production/images/rmit-sgs-campus-facilities/2019-campus-photos/sgs-campus-night-03.jpg")`,
...
export default Projects5Details;
